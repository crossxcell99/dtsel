 ...
 * @property {String} dateFormat default = 'yyyy-mm-dd'
 * @property {String} timeFormat default = 'HH:MM:SS'
 * @property {Boolean} showDate default = true
 * @property {Boolean} showTime default = false
 * @property {Number} paddingX default = 5
 * @property {Number} paddingY default = 5
 * @property {BodyType} defaultView default = 'DAYS'
 * @property {"TOP"|"BOTTOM"} direction default = 'TOP'
*/
 ...
 * @param {Node} refNode 
 */
function appendAfter(newElem, refNode) {
    refNode.parentNode.insertBefore(newElem, refNode.nextSibling);
}


/**
 * @typedef {Object} DTSel
 * @property {typeof DTS} DTS
 * @property {DTBox} DTObj
 * @property {DTUtils} fn
 */

/**
 * @typedef {Object} DTUtils
 * @property {empty} empty
 * @property {appendAfter} appendAfter
 * @property {getOffset} getOffset
 * @property {parseDate} parseDate
 * @property {renderDate} renderDate
 * @property {parseTime} parseTime
 * @property {renderTime} renderTime
 * @property {setDefaults} setDefaults
 */

/** @type {DTSel} */
var dtsel = Object.create({},{
    DTS: { value: DTS },
    DTObj: { value: DTBox },
    fn: {
        value: Object.defineProperties({}, {
            empty: { value: empty },
            appendAfter: { value: appendAfter },
